...
<div class="row justify-content-center">
    ...
    <form action= "/gurudashboard" method="POST">
    @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control  @error('nama_guru') is-invalid @enderror" value="{{old('nama_guru')}}" 
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control  @error('no_tlp') is-invalid @enderror" value="{{old('no_tlp')}}" 
