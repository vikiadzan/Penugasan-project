...
<div class="row justify-content-center">
    ...
    <form action= "/dosen/{{$dosens->id}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('nip') is-invalid @enderror" value="{{old('nip',$dosens->nip)}}
            "id="nip" name="nip">
            @error('nip')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control  @error('nama') is-invalid @enderror" value="{{old('nama',$dosens->nama)}}" 
            id="nama"  name="nama" >
            @error('nama')
            <div class="invalid-feedback">
                {{ $message }}
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control  @error('email') is-invalid @enderror" value="{{old('email',$dosens->email)}}" 
            id="email"  name="email" >
            @error('email')
            <div class="invalid-feedback">
                {{ $message }}
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control  @error('tlp') is-invalid @enderror" value="{{old('tlp',$dosens->tlp)}}" 
            id="tlp"  name="tlp" >
            @error('tlp')
            <div class="invalid-feedback">
                {{ $message }}
        ...
        <div class="container">
            ...
            <a href="../dosen" class="btn btn-danger col-md-2 offset-md-8">Kembali</a>
        </div>
