...
<div class="row justify-content-center">
    ...
    <h3 class="text-center"> Entri Data Mahasiswa</h3>
    <form action= "/mahasiswa" method="POST">
        <div class="mb-3">
            @csrf
            <label  for ="nim" class="form-label">NIM</label>
            <input type="text" class="form-control @error('nim') is-invalid @enderror" value="{{old('nim')}}
            "id="nim" name="nim">
            @error('nim')
        ...
        <div class="container">
            ...
            <a href="../mahasiswa" class="btn btn-danger col-md-2 offset-md-8">Kembali</a>
        </div>
